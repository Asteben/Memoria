# run as: python 3 join _ files .py \[\ ’ file _1\ ’ ,\ ’ file _2\ ’\]
        ...
        for file in files :
            ...
            with open ("data/" + file + ".jsonl ") as in_file :
                ...
                for line in in_file :
                    ...
                    # read the data from files and write it in file 3
...
def main():
    if len (sys.argv) < 2:
        print ("correct usage: python 3 join_files.py \[\\ ' file_1\\ ' ,\\ ' file _2\\ '\]")
        return
