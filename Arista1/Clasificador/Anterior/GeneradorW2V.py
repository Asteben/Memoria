# run as: python 3 generate_model.py corpus/example.corpus models/example.w2v
...
def GenerateModel(corpus_file_name , model_file_name):
    ...
    model = gensim.models.Word2Vec(sentences = corpus, min_count =5, vector_size = 200, workers = cores - 1)
...
def main () :
    if len (sys.argv)< 3:
        print("correct usage : python 3 generate_model.py <input_corpus_file_name > <output_model_file_name >")
        return
