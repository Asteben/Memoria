...
def exists ( model_name:str , req:GetTweetRequest ,words_per_tweet : Optional[int] = 16):
    ...
    tweet_type , tweet_words_data = ProcessLine(model , words_per_tweet , req.tweet_type , req.tweet_data.split())

    return {"type":tweet_type ,"words":len(tweet_words_data) ,"data":tweet_words_data}